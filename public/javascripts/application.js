...
function setCookie(cookieName, value, cookieDaysToExpire) {
  var dtNow = new Date();
  dtNow.setDate(dtNow.getDate() + cookieDaysToExpire);
  var cookieValueEscaped = escape(value) + ((cookieDaysToExpire == null) ? '' : '; expires=' + dtNow.toUTCString());
  document.cookie = cookieName + '=' + cookieValueEscaped;
}
